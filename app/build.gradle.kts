...
android {
    namespace = "com.example.gemaroom2"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.gemaroom2"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.squareup.okhttp3:logging-interceptor:4.9.0") // Para interceptar y ver las solicitudes
